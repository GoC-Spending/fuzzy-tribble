...
class TqdmLog(tqdm):
    ...
    class PreserveLastOutputStreamInterceptor():
        def __init__(self, output_stream: IOBase, last_output_initial_value: str = "(no output yet)"):
    ...
    @classmethod
    def pandas(tclass: type, *targs, **tkwargs): # pylint: disable=C0202
        ...
        if 'file' in tkwargs:
            ...
            def wrap_progress_apply(original_progress_apply) -> types.FunctionType:
